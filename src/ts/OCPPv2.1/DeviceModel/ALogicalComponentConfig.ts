...
export class ALogicalComponentConfig extends componentConfig.ComponentConfig {

    constructor(name:              string,
                instance?:         string,
                //variableConfigs?:  Array<componentConfig.VariableConfig>,
